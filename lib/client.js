window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = [
			...
			"}",
			".Sxvs8a_root {",
			"  text-shadow: -1px -1px 0 rgba(255,255,255,0.9), 1px -1px 0 rgba(255,255,255,0.9), -1px 1px 0 rgba(255,255,255,0.9), 1px 1px 0 rgba(255,255,255,0.9), 0 0 5px rgba(255,255,255,0.55);",
			"}",
			"body[data-ds-dark-theme] .Sxvs8a_root {",
			"  text-shadow: -1px -1px 0 rgba(0,0,0,0.9), 1px -1px 0 rgba(0,0,0,0.9), -1px 1px 0 rgba(0,0,0,0.9), 1px 1px 0 rgba(0,0,0,0.9), 0 0 5px rgba(0,0,0,0.6);",
			"}",
			"body {",
