				...
				return React.createElement("div", { className: "yukimi-pet", style: rootStyle },
					...
					React.createElement("div", { style: { position: "relative", width: "var(--yukimi-pet-size)" } },
						...
						panelOpen ? React.createElement("div", {
							...
							style: { position: "fixed", right: 12, bottom: 12, width: "min(300px, calc(100vw - 24px))", maxHeight: "min(460px, calc(100dvh - 24px))", overflowY: "auto", background: "rgba(255,255,255,0.95)", borderRadius: 12, boxShadow: "0 8px 30px rgba(20,24,60,0.35)", padding: 10 },
						},
