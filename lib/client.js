window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = [
			...
			"  .VOzbGW_nav { width: 56px; padding: 22px 8px 0; }",
			"  .VOzbGW_navTitle, .VOzbGW_navLabel { display: none; }",
			"  .VOzbGW_navCell { justify-content: center; padding: 9px; }",
			"  .VOzbGW_options { padding: 0 12px 16px; }",
			"}",
		].join("\n");
